...
exports.formatInit = (_data) => {
    var _a, _b, _c, _d;
    let startStart = ((_a = _data === null || _data === void 0 ? void 0 : _data.start) === null || _a === void 0 ? void 0 : _a.start) || defaultConfig.start.start, startEnd = ((_b = _data === null || _data === void 0 ? void 0 : _data.start) === null || _b === void 0 ? void 0 : _b.end) || defaultConfig.start.end, endStart = ((_c = _data === null || _data === void 0 ? void 0 : _data.end) === null || _c === void 0 ? void 0 : _c.start) || defaultConfig.end.start, endEnd = ((_d = _data === null || _data === void 0 ? void 0 : _data.end) === null || _d === void 0 ? void 0 : _d.end) || defaultConfig.end.end, _ = safetySrc;
    const useReg = new RegExp(`(?<!${_(startEnd)})${_(startStart)}(([$A-Za-z_][$A-Za-z0-9_]?)*|[0-9]*)${_(endStart)}(?<!${_(endEnd)})`);
